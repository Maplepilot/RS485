/*
  file: MC33926_RS485_slave.cpp
  date: 20160218
  description :
 
  this version is for RS485 slave 
  CCW for L1 R0 R1 is right!!
        
  this version is for 328p and MC33926
  baud rate: 1Mbit/S
...
#define MotorPin0 5 //328p
#define MotorPin1 6 //328p
...
void setup() { 
    ...
    /*
     * added for RS485 protocol
     */
    pinMode(RS485Eable, OUTPUT);
    digitalWrite(RS485Eable, RS485Receive); //DE,RE=LOW, RX enabled
...
void get_cmd_pos() {
    ...
    //GET POS_CMD FROM MEGA
     ...
     if(rS=='{'){
       ...
       byte rDA=commandArray[0];//device address
